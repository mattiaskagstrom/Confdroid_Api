...
class User
{
    ...
    private $id, $name, $email, $devices = array(), $groups = array(), $authToken, $dateCreated, $applications = array(), $variables = array();
    ...
    public function addVariable($id, $name, $value){
        $variable["id"] = $id;
        $variable["name"] = $name;
